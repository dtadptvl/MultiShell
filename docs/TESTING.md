...
Run dist\MultiShell-win-x64\MultiShell.exe outside the source tree and repeat one project start, Vietnamese typing, 1 MB paste, resize, terminate and tray-close check.
